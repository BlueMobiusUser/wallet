# Fuzzing BlueMobius Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing BlueMobius Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/BlueMobius/BlueMobius/blob/develop/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/BlueMobius/BlueMobius/blob/develop/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/BlueMobius/BlueMobius/blob/develop/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/BlueMobius/BlueMobius/tree/develop/src/test/fuzz).
...
Every single pull request submitted against the BlueMobius Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make BlueMobius Core more robust.
...
with certain assembly code from BlueMobius Core's code. See [developer notes on sanitizers](https://github.com/BlueMobius/BlueMobius/blob/develop/doc/developer-notes.md#sanitizers)
...
# Fuzzing BlueMobius Core using afl++

## Quickstart guide

To quickly get started fuzzing BlueMobius Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing BlueMobius Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing BlueMobius Core using [Honggfuzz](https://github.com/google/honggfuzz):
