# Support for Output Descriptors in BlueMobius Core

Since BlueMobius Core v0.17, there is support for Output Descriptors. This is a
...
existing BlueMobius Core wallets, a convenience function `combo` is
...
All RPCs in BlueMobius Core will include the checksum in their output. Only
