# BlueMobius Core version v19.3.0
...
- `wipetxes`: New command for `bluemobius-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/BlueMobius/BlueMobius/compare/v19.2.0...bluemobiuspay:v19.3.0).
