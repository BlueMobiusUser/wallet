...
This document provides guidelines for internationalization of the BlueMobius Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bluemobius_en.ts` remains unchanged.
