...
This mechanism has been integrated into Bitcore-Node-BlueMobius which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bluemobiuspay/insight-api-bluemobius#web-socket-api](https://github.com/bluemobiuspay/insight-api-bluemobius#web-socket-api)
* API: [https://github.com/bluemobiuspay/insight-api-bluemobius#instantsend-transactions](https://github.com/bluemobiuspay/insight-api-bluemobius#instantsend-transactions)
