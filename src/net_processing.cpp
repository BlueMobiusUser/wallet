 ...
 *  We have 4 times smaller block times in BlueMobius, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        BlueMobius Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // BMCOIN this code also handles non-TXs (BlueMobius specific messages)
