 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1705752081, nBits=1e0ffff0, nNonce=342810, vtx=1)
...
{
    const char* pszTimestamp = "To be or not to be that is the question";
    const CScript genesisOutputScript = CScript() << ParseHex("04ccb06c87a43406626919d96fc623c859db29e2d3587520afbab80c4178dbe732f59909237bce9e3e5f6a9086a59d107fcca061669f57cd56629c661d1c6b2f38") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000ebc15d8e98d12596fb954612ad570b8109419f84be6f79b058c0c8080a2"); 
        ...
        genesis = CreateGenesisBlock(1705752081, 342810, 0x1e0ffff0, 1, 10 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000ebc15d8e98d12596fb954612ad570b8109419f84be6f79b058c0c8080a2"));
        assert(genesis.hashMerkleRoot == uint256S("0x9beeeb752e507f124be5a281779011c5dbf30967529466574c3fcd2bd60012d8"));
        ...
        vSeeds.emplace_back("node1.bluemobius.eu");
        vSeeds.emplace_back("node2.bluemobius.eu");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,0);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,1);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // BlueMobius BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // BlueMobius BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // BlueMobius BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"1LD8PkcrUL7br7wwUuUTBqHsPG5enrKMTc"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x00000ebc15d8e98d12596fb954612ad570b8109419f84be6f79b058c0c8080a2")},
            }
        };
        ...
        // getchaintxstats 17280 00000ebc15d8e98d12596fb954612ad570b8109419f84be6f79b058c0c8080a2
        chainTxData = ChainTxData{
                1705752081, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000003db529b6ad43d6c694d95d880de5d258947bdd86d8b62bf11b663242fd4"); 
        ...
        genesis = CreateGenesisBlock(1705752086UL, 213898UL, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000003db529b6ad43d6c694d95d880de5d258947bdd86d8b62bf11b663242fd4"));
        assert(genesis.hashMerkleRoot == uint256S("0x9beeeb752e507f124be5a281779011c5dbf30967529466574c3fcd2bd60012d8"));
        ...
        // Testnet BlueMobius BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet BlueMobius BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet BlueMobius BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"AcRGGZxQVpkCkdZkfVvJa1Vmi3SYEEcvff"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x000003db529b6ad43d6c694d95d880de5d258947bdd86d8b62bf11b663242fd4")},
            }
        };
        ...
        // getchaintxstats 17280 000003db529b6ad43d6c694d95d880de5d258947bdd86d8b62bf11b663242fd4
        chainTxData = ChainTxData{
                1705752086, // * UNIX timestamp of last known number of transactions
                0,    // * total number of transactions between genesis and that timestamp
                            //   (the tx=... number in the ChainStateFlushed debug.log lines)
                0,       // * estimated number of transactions per second after that timestamp
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1705752091, 0, 0x207fffff, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x35b5ad002fca8a1536d98ee45b781ca1029e9d13d300a93c5e98d5b076d13891"));
        assert(genesis.hashMerkleRoot == uint256S("0x9beeeb752e507f124be5a281779011c5dbf30967529466574c3fcd2bd60012d8"));

        devnetGenesis = FindDevNetGenesisBlock(genesis, 10 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x35b5ad002fca8a1536d98ee45b781ca1029e9d13d300a93c5e98d5b076d13891")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // privKey: 64sKD4x6y7pBygmgrsdCQox4wiTFADrodNj4nmw7ZVBRCgHufZs
        vSporkAddresses = {"AapQfhjE3RpjraBMLi9eTyjcqspYU3Yrq9"};
        nMinSporkKeys = 1;
        ...
        // Regtest BlueMobius addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,23);
        // Regtest BlueMobius script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,24);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,151);
        // Regtest BlueMobius BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest BlueMobius BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest BlueMobius BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
