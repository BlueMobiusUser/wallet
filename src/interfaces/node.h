...
//! Interface for the src/evo part of a bluemobius node (bluemobiusd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a bluemobius node (bluemobiusd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a bluemobius node (bluemobiusd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a bluemobius node (bluemobiusd process).
...
//! Top-level interface for a bluemobius node (bluemobiusd process).
class Node
{
public:
    virtual ~Node() {}
