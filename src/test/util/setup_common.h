...
/* Initialize BlueMobius-specific components after chainstate initialization */
void BlueMobiusTestSetup(NodeContext& node);
void BlueMobiusTestSetupClose(NodeContext& node);
