...
;(function() {
  ...
  function runInContext(context) {
    // Exit early if unable to acquire lobluemobius.
    var _ = context && context._ || require('lobluemobius') || root._;
    if (!_) {
     ...
     *
     * Note: The Benchmark constructor exposes a handful of lobluemobius methods to
     * make working with arrays, collections, and objects easier. The lobluemobius
     * methods are:
     * [`each/forEach`](https://lobluemobius.com/docs#forEach), [`forOwn`](https://lobluemobius.com/docs#forOwn),
     * [`has`](https://lobluemobius.com/docs#has), [`indexOf`](https://lobluemobius.com/docs#indexOf),
     * [`map`](https://lobluemobius.com/docs#map), and [`reduce`](https://lobluemobius.com/docs#reduce)
     *
     * @constructor
     ...
     *
     * Note: Each Suite instance has a handful of wrapped lobluemobius methods to
     * make working with Suites easier. The wrapped lobluemobius methods are:
     * [`each/forEach`](https://lobluemobius.com/docs#forEach), [`indexOf`](https://lobluemobius.com/docs#indexOf),
     * [`map`](https://lobluemobius.com/docs#map), and [`reduce`](https://lobluemobius.com/docs#reduce)
     *
     * @constructor
     * @memberOf Benchmark
    ...
    // Add lobluemobius methods to Benchmark.
    ...
    // Add lobluemobius methods as Suite methods.
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    define(['lobluemobius', 'platform'], function(_, platform) {
      return runInContext({
        '_': _,
        'platform': platform
      });
