    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:  bluemobius-qt [command-line options]                     \n";
...
All the BlueMobius in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 BMCOIN, 0.01 BMCOIN, 0.1 BMCOIN, 1 BMCOIN and 10 BMCOIN -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a style=\"%2\" href=\"%3\">%1 documentation</a>."
        ...
        .arg("https://docs.bluemobius.org/en/stable/wallets/bluemobius/coinjoin-instantsend.html")
        );
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
