...
/** Utility functions used by the BlueMobius Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bluemobius:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load bluemobius specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a bluemobius specific theme is activated (light/dark).*/
