...
EXPECTED_HOLDER_NAMES = [
    ...
    r"The BlueMobius Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a BlueMobius Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BlueMobius Core developers'
...
Arguments:
    <base_directory> - The base directory of BlueMobius Core source code repository.
"""
...
Arguments:
    <file> - A source file in the BlueMobius Core repository.
"""
