# Bootstrappable BlueMobius Core Builds

This directory contains the files necessary to perform bootstrappable BlueMobius
Core builds.
...
To build BlueMobius Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      BlueMobius Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/bluemobius-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/bluemobiuspay/guix.sigs).
...
[guix-docker]: https://github.com/BlueMobius/BlueMobius/tree/master/contrib/guix/Dockerfile
