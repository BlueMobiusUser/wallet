...
"""Verify that starting bluemobiusd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bluemobiusd with -h for help text")
        ...
        self.log.info("Start bluemobiusd with -version for version information")
        ...
        self.log.info("Start bluemobiusdd with -fakearg to make sure it does not start")
