...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: BlueMobius's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'BlueMobius', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']
